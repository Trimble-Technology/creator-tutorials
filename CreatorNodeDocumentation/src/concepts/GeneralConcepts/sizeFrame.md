...
* It is important to note that it is up to the author to ensure that the effects of the size frame accurately reflect the expected behaviour of the [Live Component](/concepts/GeneralConcepts/liveComponent.md). Here are a couple of things to look out for:
    ...
    * Be sure that the intended direction of a geometry being manipulated by the size frame is acting in the correct way.
