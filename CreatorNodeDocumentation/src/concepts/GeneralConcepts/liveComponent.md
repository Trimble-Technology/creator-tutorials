...
* A Live Component can have a [**geometry input**](/nodes/GeometryInputV2/documentation.md) node which is the entry point for SketchUp geometry into the graph, enabling a component to [AutoFit](/concepts/GeneralConcepts/autoFit.md) to geometry that already exists in a user’s model.
