...
* When the _interpolate_ input is set to true, the resulting loft geometry will tightly follow the input curves. This will be more noticeable when the _order U_ input is greater than `2`.
