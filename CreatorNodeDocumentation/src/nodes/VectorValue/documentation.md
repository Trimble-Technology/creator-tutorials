...
* _x_
  ...
  * The x component of the vector value.

* _y_

  * The y component of the vector value.

* _z_

  * The z component of the vector value.
...
* Other names for this node include: VectorValue, Point, Coordinate, Direction, and xyz.
