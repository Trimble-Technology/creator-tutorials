...
> #### DEPRECATED
>
> This operator only creates a total sum of the first vector of each respective list connection.
>
> Superseded by [Add vectors](/nodes/AddVectorsV2/documentation.md)
