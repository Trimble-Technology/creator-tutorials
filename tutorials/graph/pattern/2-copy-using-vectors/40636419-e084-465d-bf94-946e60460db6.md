We can also set the direction that the geometry is rotated towards and around by setting the *normals* and *up vectors* inputs of the **copy using vectors** node.
