Now we just need to set the correct rotation that the sleepers will be in, around the direction that they’re facing. This is done via the _up vectors_ input.
